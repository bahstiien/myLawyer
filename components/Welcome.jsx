        ...
        <div className="flex justify-around mt-8 flex-col md:flex-row">
          <div className="w-full md:w-2/5">
            ...
            <p className={style.description}>
              ...
              cabinet Adaltys (Lyon), au sein de l’équipe “droit immobilier” qui
              accompagne ses clients sur les problématiques immobilières
            ...
            <p className={style.description}>
              ...
              entreprises et des particuliers dans le cadre de leurs projets et
              problématiques immobilières. Elle accompagne en particulier ses
              clients sur des problématiques liées aux baux commerciaux, baux
              d’habitation et contrats divers du secteur de la construction.
            </p>
